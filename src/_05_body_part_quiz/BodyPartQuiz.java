...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String firstGuess = JOptionPane.showInputDialog("who is this?");

		// 5. Check their answer. If they guessed correctly:
		// -- Tell them they are right and increase the score by 1
		if (firstGuess.equalsIgnoreCase("Arnold Schwarzenegger")) {
		...
		String secondGuess = JOptionPane.showInputDialog("who is this?");
		if (secondGuess.equalsIgnoreCase("Leonardo DiCaprio")) {
			JOptionPane.showMessageDialog(null,"Correct");
			score += 1;
		}
		else {
		...
		String thirdGuess = JOptionPane.showInputDialog("who is this?");
		if (thirdGuess.equalsIgnoreCase("Morgan Freeman")) {
			JOptionPane.showMessageDialog(null, "Correct");
			score += 1;
		}
		else {
		...
		String fourthGuess = JOptionPane.showInputDialog("who is this?");
		if (fourthGuess.equalsIgnoreCase("Jack Black")) {
			JOptionPane.showMessageDialog(null,"Correct");
			score += 1;
		}
		else {
